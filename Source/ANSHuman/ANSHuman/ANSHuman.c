...
static
void ANSSetChildrenCount(ANSHuman *human, unsigned short count);
...
static
void ANSSetChildOfIndex(ANSHuman *human, ANSHuman *child, unsigned short index);
...
void ANSSetHumanAge(ANSHuman *human, unsigned short age) {
    assert(human);
